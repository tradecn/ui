...
describe("the demo source shown under Code", () => {
  ...
  it("has one demo per item, and a demo only for an item, a docs page of the same name, a variant a doc places, or the desk", async () => {
    ...
    expect([...placed.keys()].sort()).toEqual(["countdown-compact", "countdown-expired", "countdown-thresholds", "data-grid-controlled", "data-grid-selection", "data-grid-totals", "data-grid-updates", "price-chart-candles", "price-chart-overlays", "quote-panel-actions", "quote-panel-limits", "quote-panel-pending", "workspace-keyboard", "workspace-linked-panels", "workspace-panel-actions", "workspace-saved-layout"])
...
describe("a theme on the site", () => {
  ...
  it("wears its own palette on its own preview page in both modes; every other page wears the site theme's two sides and carries every other theme's, keyed on the choice", async () => {
    ...
    expect(variants).toEqual(["countdown-compact", "countdown-expired", "countdown-thresholds", "data-grid-controlled", "data-grid-selection", "data-grid-totals", "data-grid-updates", "price-chart-candles", "price-chart-overlays", "quote-panel-actions", "quote-panel-limits", "quote-panel-pending", "workspace-keyboard", "workspace-linked-panels", "workspace-panel-actions", "workspace-saved-layout"])
