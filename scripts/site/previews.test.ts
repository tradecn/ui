...
describe("the demo source shown under Code", () => {
  it("opts table previews into shared alignment without adding controls to copied source", async () => {
    ...
    expect(alignable).toEqual(["data-grid", "data-grid-controlled", "data-grid-selection", "data-grid-totals", "data-grid-updates", "quote-panel", "quote-panel-pending", "quote-panel-actions", "quote-panel-limits", "rfq-stack", "rfq-stack-threshold", "rfq-stack-parking", "rfq-stack-updates", "row-store", "row-store-deltas", "row-store-batching", "row-store-views", "depth-ladder", "depth-ladder-updates", "depth-ladder-following", "spread-matrix", "spread-matrix-yields", "spread-matrix-structures", "spread-matrix-updates", "watchlist", "watchlist-prices", "watchlist-trends", "positions", "positions-formats", "positions-books", "positions-updates"])
  ...
  it("has one demo per item, and a demo only for an item, a docs page of the same name, a variant a doc places, or the desk", async () => {
    ...
    expect([...placed.keys()].sort()).toEqual(["command-palette-go-bar", "command-palette-scoped-actions", "command-palette-shared-recents", "command-palette-symbols", "countdown-compact", "countdown-expired", "countdown-thresholds", "data-grid-controlled", "data-grid-selection", "data-grid-totals", "data-grid-updates", "depth-ladder-following", "depth-ladder-updates", "panel-hotkeys", "panel-linked", "panel-popout", "panel-states", "positions-books", "positions-formats", "positions-updates", "price-chart-candles", "price-chart-overlays", "price-chart-ticks", "quote-panel-actions", "quote-panel-limits", "quote-panel-pending", "rfq-stack-parking", "rfq-stack-threshold", "rfq-stack-updates", "rfq-ticket-server", "rfq-ticket-shortcuts", "rfq-ticket-sides", "row-store-batching", "row-store-deltas", "row-store-views", "spread-matrix-structures", "spread-matrix-updates", "spread-matrix-yields", "use-hotkeys-chords", "use-hotkeys-editing", "use-hotkeys-remapping", "use-hotkeys-scopes", "watchlist-prices", "watchlist-trends", "workspace-keyboard", "workspace-linked-panels", "workspace-panel-actions", "workspace-saved-layout"])
