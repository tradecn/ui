...
const CHANNELS: Array<{ file: string; channel: string; proof: RegExp }> = [
  ...
  { file: "ui/feed-health.tsx", channel: "the dot is aria-hidden; the indicator includes a screen-reader state word and compact recipes retain the tier word", proof: /className="sr-only">\{feed.state\}/ },
