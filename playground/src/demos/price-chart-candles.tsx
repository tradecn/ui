...
export default function PriceChartCandlesDemo() {
  ...
  return <div className="w-xl max-w-full"><PriceChart store={store} convention={ES} kind="candles" label="ES sample, five-minute candles" zone="America/Chicago" baseline={5010} className="h-72" /></div>
}
